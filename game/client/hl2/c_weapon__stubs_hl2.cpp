...
STUB_WEAPON_CLASS( weapon_stickybomb, WeaponStickybomb, C_BaseHLCombatWeapon );
STUB_WEAPON_CLASS( weapon_nailgun, WeaponNailgun, C_BaseHLCombatWeapon );
...
STUB_WEAPON_CLASS( weapon_COMBAT, WeaponCOMBAT, C_BaseHLBludgeonWeapon );
STUB_WEAPON_CLASS( weapon_minigun, WeaponMINIGUN, C_HLSelectFireMachineGun );
#ifdef HL2_EPISODIC
