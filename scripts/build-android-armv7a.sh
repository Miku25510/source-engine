...
# portal    ->  Portal
./waf configure -T release --build-gameh=episodic --prefix=srceng-mod-launcher/android --android=armeabi-v7a-hard,host,21 --target=../armeabi-v7a --32bits --enable-opus --togles --disable-warns &&
